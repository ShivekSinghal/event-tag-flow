// npm dependencies: typescript, qrcode. Python dependencies: reportlab, python-docx.
...
try {
  ...
  const args = [join(root, 'scripts/generate-individual-game-assets.py'), data, publicDir];
